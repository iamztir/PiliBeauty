...
<script>
jQuery(function() {
  var paypal = jQuery('li.payment_method_paypal').clone();
  paypal.find('label').eq(0).html('Credit Card');
  paypal.append('<img src="https://www.piliani.com/wp-content/uploads/2017/09/credit-cards-logos_orig.png">');
  jQuery('.payment_methods').append(paypal);
});
</script>
<style>
