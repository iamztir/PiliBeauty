...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<div id="sub-total-wrapper">
	<div class="sub-image"></div>
	
	<div class="sub-total-body">
	<table class="table borderless cart-totals" cellspacing="0">
		...
		<?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
			<tr class="cart-discount coupon-<?php echo esc_attr( $code ); ?>">
				...
				<td class="subtotal-price"><?php wc_cart_totals_coupon_html( $coupon ); ?></td>
			</tr>
		<?php endforeach; ?>
<!--
		...
		<?php elseif ( WC()->cart->needs_shipping() ) : ?>
			...
			<tr class="shipping">
				<td class="cart-name"><?php _e( 'SHIPPING', 'woocommerce' ); ?></td>
				<td class="subtotal-price text-right"><?php woocommerce_shipping_calculator(); ?></td>
			</tr>
		...
		<tr class="order-total">
			<td class="subtotal-name total"><?php _e( 'TOTAL', 'woocommerce' ); ?></td>
			<td class="subtotal-price text-right"><?php wc_cart_totals_order_total_html(); ?></td>
		</tr>
